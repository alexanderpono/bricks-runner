...
export class AppController {
    field: GameField = GameField.create();
    emptyField: GameField = GameField.create();
    graph: GraphV5 = GraphV5.create();
    pic;
    manScreenXY: Point2D = defaultPoint2D;
    goldScreenXY: Point2D = defaultPoint2D;
    manFieldXY: Point2D = defaultPoint2D;
    nextManFieldXY: Point2D = defaultPoint2D;
    manVIndex: number = 0;
    nextManVIndex: number = 0;
